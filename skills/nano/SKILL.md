...
```
1. bunx -y xno-skills@3.2.4 <command>
2. pnpm dlx xno-skills@3.2.4 <command>
3. npx -y xno-skills@3.2.4 <command>
```
...
- **Supply chain**: Only use `xno-skills@3.2.4` and `@open-wallet-standard/core`. No other npm packages.
...
```bash
bunx -y xno-skills@3.2.4 balance --wallet "my-wallet"
bunx -y xno-skills@3.2.4 rpc account-balance <address>
```
...
**Via CLI (required flags only):**
```bash
bunx -y xno-skills@3.2.4 receive --wallet "my-wallet"
```
...
**Via CLI (required flags only):**
```bash
bunx -y xno-skills@3.2.4 send --wallet "my-wallet" --to "nano_..." --amount-xno 0.01
```
...
```bash
bunx -y xno-skills@3.2.4 qr nano_1abc...
```
...
**Via CLI:**
```bash
bunx -y xno-skills@3.2.4 validate nano_1abc...
```
...
**Via CLI:**
```bash
bunx -y xno-skills@3.2.4 convert 1 xno       # all units
bunx -y xno-skills@3.2.4 convert 1 knano
bunx -y xno-skills@3.2.4 convert 1000000000000000000000000000000 raw
bunx -y xno-skills@3.2.4 convert 1 xno --json
```
...
bunx -y xno-skills@3.2.4 sign "<message>" --key YOUR_PRIVATE_KEY_HEX

# Sign with JSON output
bunx -y xno-skills@3.2.4 sign "<message>" --key YOUR_PRIVATE_KEY_HEX --json
```
...
```bash
# Verify
bunx -y xno-skills@3.2.4 verify <nano_address> "<message>" <signature-hex>

# Verify with JSON output
bunx -y xno-skills@3.2.4 verify <nano_address> "<message>" <signature-hex> --json
```
...
```
```bash
bunx -y xno-skills@3.2.4 change-rep --wallet "my-wallet" --representative "nano_..."
```
...
```bash
bunx -y xno-skills@3.2.4 rpc probe-caps <url>
```
