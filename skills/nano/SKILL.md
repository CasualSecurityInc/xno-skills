...
```
1. bunx -y xno-skills@4.1.0 <command>
2. pnpm dlx xno-skills@4.1.0 <command>
3. npx -y xno-skills@4.1.0 <command>
```
...
- **Supply chain**: Only use `xno-skills@4.1.0` and `@open-wallet-standard/core`. No other npm packages.
...
```bash
bunx -y xno-skills@4.1.0 balance --wallet "my-wallet"
bunx -y xno-skills@4.1.0 rpc account-balance <address>
```
...
**Via CLI (required flags only):**
```bash
bunx -y xno-skills@4.1.0 receive --wallet "my-wallet"
```
...
**Via CLI (required flags only):**
```bash
bunx -y xno-skills@4.1.0 send --wallet "my-wallet" --to "nano_..." --amount-xno 0.01
```
...
```bash
bunx -y xno-skills@4.1.0 qr nano_1abc...
```
...
**Via CLI:**
```bash
bunx -y xno-skills@4.1.0 validate nano_1abc...
```
...
**Via CLI:**
```bash
bunx -y xno-skills@4.1.0 convert 1 xno       # all units
bunx -y xno-skills@4.1.0 convert 1 knano
bunx -y xno-skills@4.1.0 convert 1000000000000000000000000000000 raw
bunx -y xno-skills@4.1.0 convert 1 xno --json
```
...
bunx -y xno-skills@4.1.0 sign "<message>" --key YOUR_PRIVATE_KEY_HEX

# Sign with JSON output
bunx -y xno-skills@4.1.0 sign "<message>" --key YOUR_PRIVATE_KEY_HEX --json
```
...
```bash
# Verify
bunx -y xno-skills@4.1.0 verify <nano_address> "<message>" <signature-hex>

# Verify with JSON output
bunx -y xno-skills@4.1.0 verify <nano_address> "<message>" <signature-hex> --json
```
...
```
```bash
bunx -y xno-skills@4.1.0 change-rep --wallet "my-wallet" --representative "nano_..."
```
